...
//		}
			...
			//SWAP
			print("<TH rowspan='2' align=center width=70><font size=$lsz color=#FFFFFF>SWAP</font><br><a class=mail href=\"full_disk.php?date=$date&type=$fd_types[14]\"><font size=$lsz>$fd_strs3[12]</font></a>\n");
			//Fulldisk slide show
...
//		print("	</tr>\n");
	...
	function write_bottom_clean(){
		print("<table width=100% height=100% cellpadding=0 cellspacing=0 border=0>\n");
		print("   <tr>\n");
		print("       <td class='leftdown' valign=top align=left height=24px>\n");
		print("       </td>\n");
		print("       <td align=center>\n");
				//Close the rounded corner table.
		print("<br>");
		print("       </td>\n");
		print("       <td class='rightdown' align=right valign=top height=24px>\n");
		print("       </td>\n");
		print("   </tr>\n");
		print("</table>\n");
