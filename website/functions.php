			...
			if ($dir_handle = opendir($dir))
			{
				...
				while(false !== ($file = readdir($dir_handle)))
				{
					if(($file != ".") && ($file != ".."))
					{
						...
						if ($folder == "meta")
						{
							list($meta1, $rest) = preg_split("/[_.]/", $file, 2);
							if ($meta1 != "forecast")
								list($meta2, $rest) = preg_split("/[_.]/", $rest, 2);
						}
						else
							$rest = $file;
						...
						{
							list($file_date, $file_time, $rest) = preg_split("/[_.]/", $rest); 
						}
						elseif (($fd_ar_type == "ch") && ($fd_ar == "ch"))
						{
							list($file_date, $file_time, $rest) = preg_split("/[_.]/", $rest, 3);	
						}
						...
						{
							list($file_region, $file_date, $file_time, $rest) = preg_split("/[_.]/", $rest, 4);
