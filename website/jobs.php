						...
						<table width=640>
							<tr>
								<td>
									...
									<?
										$file = "common_files/jobs/jobslist.txt";
										if (file_exists($file))
										{
											$lines=file($file);
											print("										<b>Jobs Offers:</b>\n");
											print("											<tr> <td align=left width=20%> Deadline </td>\n");
											print("                          					 <td align=left>  </td>\n");
											print("											</tr>\n");
											foreach($lines as $line)
											{
												list($job_date, $description,$text) = split('[|]', $line,3);
												print("										<tr>\n");
												print("											<td align=left width=20%>\n");
												print("												$job_date\n");
												print("											</td>\n");
												print("											<td align=left>\n");
												print("												<a href=jobsdescription.php?offer=$description>");
												print("												$text</a>\n");
												print("											</td>\n");
												print("										</tr>\n");
											}											
